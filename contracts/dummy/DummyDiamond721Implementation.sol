...
contract DummyDiamond721Implementation {
    ...
    function createEdition(string memory _name, uint256 _maxSupply, uint256 _price) external {}
    ...
    function explicitOwnershipOf(uint256 tokenId) external view returns (Tuple4362849 memory) {}

    function explicitOwnershipsOf(uint256[] memory tokenIds) external view returns (Tuple4244095[] memory) {}
